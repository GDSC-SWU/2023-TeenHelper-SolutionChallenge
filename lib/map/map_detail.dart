      ...
      floatingActionButton: Padding(
        ...
        child: SizedBox(
          ...
          child: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (_) => review_write_screen()));
            },
          ),
        ),
      ),
            ...
            Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(left: ScreenUtil().setWidth(8)),
                      child: Text("forten1318@hanmail.net",
                          style: TextStyle(
                            color: Color(0xFF353535),
                            fontSize: 14,
                          )),
